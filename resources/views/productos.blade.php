                ...
                <div class="p-4">
                    ...
                    <div id="caldo-menu" class="hidden mt-4">
                        ...
                        <ul class="list-disc pl-5 text-gray-600">
                            <li><input type="checkbox" id="caldo-item1" name="caldo-item1"><label for="caldo-item1"> Caldo de Costilla </label></li>
                            <li><input type="checkbox" id="caldo-item2" name="caldo-item2"><label for="caldo-item2"> Caldo de Gallina </label></li>
                            <li><input type="checkbox" id="caldo-item3" name="caldo-item3"><label for="caldo-item3"> Caldo de Huevo </label></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white shadow-md rounded-lg overflow-hidden">
                ...
                <div class="p-4">
                    ...
                    <div id="huevos-menu" class="hidden mt-4">
                        <h4 class="text-lg font-semibold text-gray-800">Menú del Día</h4>
                        <ul class="list-disc pl-5 text-gray-600">
                            <li><input type="checkbox" id="huevos-item1" name="huevos-item1"><label for="huevos-item1"> Huevos Fritos </label></li>
                            <li><input type="checkbox" id="huevos-item2" name="huevos-item2"><label for="huevos-item2"> Huevos Pericos </label></li>
                            <li><input type="checkbox" id="huevos-item3" name="huevos-item3"><label for="huevos-item3"> Huevos Rancheros </label></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white shadow-md rounded-lg overflow-hidden">
                ...
                <div class="p-4">
                    ...
                    <div id="empanadas-menu" class="hidden mt-4">
                        <h4 class="text-lg font-semibold text-gray-800">Menú del Día</h4>
                        <ul class="list-disc pl-5 text-gray-600">
                            <li><input type="checkbox" id="empanadas-item1" name="empanadas-item1"><label for="empanadas-item1"> Empanadas de Pollo</label></li>
                            <li><input type="checkbox" id="empanadas-item2" name="empanadas-item2"><label for="empanadas-item2"> Empanadas de Carne</label></li>
                            <li><input type="checkbox" id="empanadas-item3" name="empanadas-item3"><label for="empanadas-item3"> Empanadas Rancheras </label></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white shadow-md rounded-lg overflow-hidden">
                ...
                <div class="p-4">
                    ...
                    <div id="corriente-menu" class="hidden mt-4">
                        <h4 class="text-lg font-semibold text-gray-800">Menú del Día</h4>
                        <ul class="list-disc pl-5 text-gray-600">
                            <li><input type="checkbox" id="corriente-item1" name="corriente-item1"><label for="corriente-item1"> Pollo Frito </label></li>
                            <li><input type="checkbox" id="corriente-item2" name="corriente-item2"><label for="corriente-item2"> Pechuga a la plancha</label></li>
                            <li><input type="checkbox" id="corriente-item3" name="corriente-item3"><label for="corriente-item3"> Carne a la plancha </label></li>
                            <li><input type="checkbox" id="corriente-item3" name="corriente-item3"><label for="corriente-item3"> Carne sudada </label></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white shadow-md rounded-lg overflow-hidden">
                ...
                <div class="p-4">
                    ...
                    <div id="especial-menu" class="hidden mt-4">
                        <h4 class="text-lg font-semibold text-gray-800">Menú del Día</h4>
                        <ul class="list-disc pl-5 text-gray-600">
                            <li><input type="checkbox" id="especial-item1" name="especial-item1"><label for="especial-item1"> Pechuga Rellena </label></li>
                            <li><input type="checkbox" id="especial-item2" name="especial-item2"><label for="especial-item2"> Arroz Mixto </label></li>
                            <li><input type="checkbox" id="especial-item3" name="especial-item3"><label for="especial-item3"> Fricase de Pollo </label></li>
                            <li><input type="checkbox" id="especial-item3" name="especial-item3"><label for="especial-item3"> Lasaña </label></li>
                        </ul>
                    </div>
                </div>
            </div>
...
                <ul class="list-disc pl-5 text-gray-600">
                    <li><input type="checkbox" id="bebida-item1" name="bebida-item1"><label for="bebida-item1"> Gaseosas </label></li>
                    <li><input type="checkbox" id="bebida-item2" name="bebida-item2"><label for="bebida-item2"> Jugos </label></li>
                    <li><input type="checkbox" id="bebida-item3" name="bebida-item3"><label for="bebida-item3"> Agua </label></li>
                </ul>
            </div>
        </div>
    </div>
