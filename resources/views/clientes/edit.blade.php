...
<head>
    ...
    <title>Editar Cliente - GastroSoft</title>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('clientes.update', $cliente->id) }}" method="POST">
                    @csrf
                    @method('PUT') {{-- Importante para el método PUT/PATCH en Laravel --}}
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="direccion" name="direccion">{{ old('direccion', $cliente->direccion) }}</textarea>
                    </div>
